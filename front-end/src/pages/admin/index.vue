<template>
  <div class="bg-blue-600 h-20 w-full">Header</div>
  <span class="absolute text-white text-4xl top-5 left-4 cursor-pointer">
    <i class="bi bi-filter-left px-2 bg-gray-900 rounded-md"></i>
  </span>
  <div
    class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-700"
  >
    ...
    >
      ...
      <router-link to="/admin" class="text-[15px] ml-4 text-gray-200 font-bold"
